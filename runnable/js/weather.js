...
$(function () {
    ...
    var wuApiKey = '6a5ab736cc2ff689';
    var wuPrefix = 'https://api.wunderground.com/api/';
    ...
    if ($.cookie('location') && $.cookie('location_text')) {
        ...
        //alert("cookie location = " + location + ", location text = " + locationText);
    } else {
        locationText = 'Houston, Texas'; // 'Columbus, Ohio';
        var location = '/q/zmw:77001.1.99999'; // '/q/zmw:43085.2.99999';
    }
    ...
    $('body').on('click', '.location-list li', function () {
       ...
       // alert("body on-click location = " + location + ", location text = " + locationText);
    ...
    locationInput.keyup(function () {
        ...
        var cityRequest = 'https://autocomplete.wunderground.com/aq?query=' + query;
        if (query.length < 2) {
            $('#location-results').empty();
        } else {
